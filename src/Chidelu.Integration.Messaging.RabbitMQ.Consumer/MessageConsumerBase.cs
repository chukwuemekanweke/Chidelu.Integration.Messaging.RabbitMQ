...
internal abstract class MessageConsumerBase(
    ...
    ILogger? logger = null) : IAsyncDisposable
{
    ...
    protected void AddHandlerInternal<TMessage, THandler>()
    ...
    protected async Task StartInternalAsync(CancellationToken cancellationToken)
    {
